...
public class FarmerDialog extends Dialog {
    ...
    public FarmerDialog(Context context) {
        this(context, 0);
    }

    public FarmerDialog(Context context, int themeResId) {
        super(context, themeResId);
        //		setCustomDialogUpdate();
        setCustomDialog(null);
    }

    public FarmerDialog(Context context, int themeResId, RateDialogItem data) {
        super(context, themeResId);
    ...
    private void setCustomDialog(RateDialogItem data) {
        //		if (data != null) {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_farmer, null);
        TextView tvQx = (TextView) mView.findViewById(R.id.farmer_qx);
        ...
        Button stewardBtn = (Button) mView.findViewById(R.id.farmer_btn);
