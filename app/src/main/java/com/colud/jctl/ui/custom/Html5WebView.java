...
public class Html5WebView extends WebView {
    ...
    public void addProgressBar() {
        ...
        progressBar.setLayoutParams(new LayoutParams(ViewPager.LayoutParams.MATCH_PARENT, 5, 0, 0));
        progressBar.setProgressDrawable(getContext().getResources().getDrawable(R.drawable.bg_pb_web_loading));
        addView(progressBar);// 添加进度条到WebView中
