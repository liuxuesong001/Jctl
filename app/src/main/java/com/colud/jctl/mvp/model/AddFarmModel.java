...
public class AddFarmModel implements AddFarmContract.Model {
    ...
    @Override
    public Observable<AddFarmItem> getAddFarmData(Map<String, String> map) {
        return ApiEngine.getInstance().getApiService().getAddFarmData(
                map)
                .compose(RxSchedulers.<AddFarmItem>switchThread());
    }
