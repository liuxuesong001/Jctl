//package com.colud.jctl.utils.volley;
//
...
//        // 清除请求队列中的tag标记请求
//        JctlApplication.getHttpQuesue().cancelAll(tag);
//        // 创建当前的请求，获取字符串内容
...
//        // 将当前请求添加到请求队列中
//        JctlApplication.getHttpQuesue().add(stringRequest);
//        // 重启当前请求队列
//        JctlApplication.getHttpQuesue().start();
//    }
//
//    /*
