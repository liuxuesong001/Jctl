...
public class NetworkConnectChangedReceiver extends BroadcastReceiver {
    ...
    //    private static final String TAG = "liusong";
    //    public static final String TAG1 = "liusongxxx";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            //            KLog.e("wifiState=" + wifiState);
            switch (wifiState) {
                case WifiManager.WIFI_STATE_DISABLED:
                    JctlApplication.getAppInstance().setEnablaWifi(false);
                    break;
                ...
                case WifiManager.WIFI_STATE_ENABLED:
                    JctlApplication.getAppInstance().setEnablaWifi(true);
                    break;
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                //                KLog.e(TAG1, "isConnected=" + isConnected);
                if (isConnected) {
