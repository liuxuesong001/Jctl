...
public class NodeDetailsFragmentAdapter extends SwipeMenuAdapter<NodeDetailsFragmentAdapter.DefaultViewHolder> {
    ...
    public static void setIsSelected(SparseBooleanArray isSelected) {
        NodeDetailsFragmentAdapter.isSelected = isSelected;
    }

    public NodeDetailsFragmentAdapter(List<String> titles) {
        this.titles = titles;
    ...
    @Override
    public NodeDetailsFragmentAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
        NodeDetailsFragmentAdapter.DefaultViewHolder viewHolder = new NodeDetailsFragmentAdapter.DefaultViewHolder(realContentView);
    ...
    @Override
    public void onBindViewHolder(NodeDetailsFragmentAdapter.DefaultViewHolder holder, int position) {
