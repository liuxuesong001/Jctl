...
public class LvRightAdapter extends BaseAdapter {
    ...
    public LvRightAdapter(Context context, List<String> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.fragment_node_right, null);
            //            holder.tv_goodname = (TextView) convertView.findViewById(R.id.right_tv);
