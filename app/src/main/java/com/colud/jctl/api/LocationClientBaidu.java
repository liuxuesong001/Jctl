...
public class LocationClientBaidu {

    private LocationClient realClient;

    private static volatile LocationClientBaidu proxyClient;

    private LocationClientBaidu(Context context) {
    ...
    public static LocationClientBaidu get(Context context) {
        if (proxyClient == null) {
            synchronized (LocationClientBaidu.class) {
                if (proxyClient == null) {
                    proxyClient = new LocationClientBaidu(context.getApplicationContext());
                }
            }
        }
        return proxyClient;
